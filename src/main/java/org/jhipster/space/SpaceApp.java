...
import java.util.*;
import org.jhipster.space.config.DefaultProfileUtil;
...
public class SpaceApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(SpaceApp.class);

    /**
     * Initializes SpaceApp.
     * <p>
