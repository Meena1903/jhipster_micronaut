...
import { sampleWithRequiredData } from '../mission.test-samples';
...
describe('Mission Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, MissionComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to missionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMissionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMissionIdentifier).toHaveBeenCalledWith(entity);
