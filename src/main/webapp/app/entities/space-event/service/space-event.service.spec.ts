...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../space-event.test-samples';

import { SpaceEventService, RestSpaceEvent } from './space-event.service';
