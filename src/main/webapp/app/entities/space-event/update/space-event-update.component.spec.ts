...
describe('SpaceEvent Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SpaceEventUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call mission query and add missing value', () => {
      ...
      const mission: IMission = { id: 26061 };
      spaceEvent.mission = mission;

      const missionCollection: IMission[] = [{ id: 3948 }];
    ...
    it('Should update editForm', () => {
      const spaceEvent: ISpaceEvent = { id: 456 };
      const mission: IMission = { id: 30352 };
      spaceEvent.mission = mission;
