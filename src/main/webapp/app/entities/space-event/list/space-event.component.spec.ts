...
import { sampleWithRequiredData } from '../space-event.test-samples';
...
describe('SpaceEvent Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SpaceEventComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to spaceEventService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpaceEventIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpaceEventIdentifier).toHaveBeenCalledWith(entity);
