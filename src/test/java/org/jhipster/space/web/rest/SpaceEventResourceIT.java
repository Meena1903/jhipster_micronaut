...
public class SpaceEventResourceIT {
    ...
    public void initTest() {
        spaceEvent = createEntity(transactionManager, em);
    }
     ...
     */
    public static SpaceEvent createEntity(TransactionOperations<Connection> transactionManager, EntityManager em) {
    ...
    public void createSpaceEvent() throws Exception {
        ...
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.POST("/api/space-events", spaceEvent), SpaceEvent.class)
            .blockingFirst();
    ...
    public void createSpaceEventWithExistingId() throws Exception {
        ...
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.POST("/api/space-events", spaceEvent), SpaceEvent.class)
            .onErrorReturn(t -> (HttpResponse<SpaceEvent>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void getAllSpaceEvents() throws Exception {
        ...
        List<SpaceEvent> spaceEvents = client
            .retrieve(HttpRequest.GET("/api/space-events?eagerload=true"), Argument.listOf(SpaceEvent.class))
            .blockingFirst();
    ...
    public void getSpaceEvent() throws Exception {
        ...
        // Get the spaceEvent
        SpaceEvent testSpaceEvent = client
            .retrieve(HttpRequest.GET("/api/space-events/" + spaceEvent.getId()), SpaceEvent.class)
            .blockingFirst();
    ...
    public void getNonExistingSpaceEvent() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.GET("/api/space-events/" + Long.MAX_VALUE), SpaceEvent.class)
            .onErrorReturn(t -> (HttpResponse<SpaceEvent>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void updateSpaceEvent() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.PUT("/api/space-events/" + spaceEvent.getId(), updatedSpaceEvent), SpaceEvent.class)
            .onErrorReturn(t -> (HttpResponse<SpaceEvent>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void updateNonExistingSpaceEvent() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.PUT("/api/space-events/" + spaceEvent.getId(), spaceEvent), SpaceEvent.class)
            .onErrorReturn(t -> (HttpResponse<SpaceEvent>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void deleteSpaceEvent() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpaceEvent> response = client
            .exchange(HttpRequest.DELETE("/api/space-events/" + spaceEvent.getId()), SpaceEvent.class)
            .onErrorReturn(t -> (HttpResponse<SpaceEvent>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
